      ...
      <div className="container">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
            ...
            <span className="text-gradient">Is Easy</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Quick Eligibility • Transparent Pricing • Complete Checkout in 5
            Minutes
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <p className="text-center text-muted-foreground mb-4">
            Watch how Klump works on Jumia in under 2 minutes
          </p>
          <div className="relative aspect-video rounded-2xl overflow-hidden shadow-card border border-border">
            <iframe
              className="absolute inset-0 w-full h-full"
              src="https://www.youtube.com/embed/FNNSqxHy6ks"
              title="How to Pay With Klump on Jumia"
              frameBorder="0"
